...
mkdir 正式包\res\achannel\12
xcopy res\achannel\12 正式包\res\achannel\12 /e
...
mkdir 渠道12
xcopy 正式包 渠道12 /e
mkdir 正式包\src\version\12
mkdir 渠道12\src\version\12
copy ".\src\version\12\*" ".\渠道12\src\version\12\"
:这里删除不需要的文件夹，例如：rd /s/q 文件名
start /wait VerstionBuild.exe 渠道12\ 渠道12\src\version\12\version.manifest 渠道12\src\version\12\project.manifest
copy ".\渠道12\src\version\12\*" ".\正式包\src\version\12\"
