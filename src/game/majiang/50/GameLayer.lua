...
--            end
        ...
        elseif subCmdID == NetMsgId.SUB_S_OPERATE_RESULT then              --操作结果
            ...
            print("---------------用户操作",_tagMsg.pBuffer.cbOperateCode,_tagMsg.pBuffer.cbPublicCard,_tagMsg.pBuffer.cbUserCardCout)
            ...
            uiPanel_end:runAction(cc.Sequence:create(
                ...
                cc.CallFunc:create(function(sender,event) 
                    if GameCommon.tableConfig.nTableType == TableType_SportsRoom then
                        ...
                        uiPanel_end:addChild(require("game.majiang.50.GameEndLayer"):create(pBuffer))
                    end 
                end),
...
--                end
            ...
            if pBuffer.wDiceCardOne ~= 0 then
                self.tableLayer:doAction(NetMsgId.SUB_S_CASTDICE_RESULT, {wCurrentUser = pBuffer.wCurrentUser, wDiceCount = 0, wDiceCardOne = pBuffer.wDiceCardOne, wDiceCardTwo = pBuffer.wDiceCardTwo})
