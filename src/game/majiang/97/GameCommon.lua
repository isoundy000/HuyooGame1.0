...
function GameCommon:getViewIDByChairID(wChairID,isChange)
...
function GameCommon:GetCardHand(data,viewID)
    ...
    if CHANNEL_ID == 20 or CHANNEL_ID == 21 then 
        cardIndex = cc.UserDefault:getInstance():getIntegerForKey(Default.UserDefault_MaJiangCard,3)
    else
        cardIndex = cc.UserDefault:getInstance():getIntegerForKey(Default.UserDefault_MaJiangCard,0)
    end 
    if (GameCommon.tableConfig.wKindID == 65 or GameCommon.tableConfig.wKindID == 54)and data == 0x31 then 
	    ...
	    if viewID == 2 then
	        if data == 0 then
	             if cardIndex == 0 then
	                local card = ccui.ImageView:create("majiang/card/card0/hand_cardright_bg.png")
	                card:setFlippedX(true)
	                return card
	             elseif cardIndex == 1 then
	                local card = ccui.ImageView:create("majiang/card/card1/hand_cardright_bg.png")
	                card:setFlippedX(true)
	                return card
	            elseif cardIndex == 2 then
	                local card = ccui.ImageView:create("majiang/card/card2/hand_cardright_bg.png")
	                card:setFlippedX(true)
	                return card
                elseif cardIndex == 3 then
                    local card = ccui.ImageView:create("majiang/card/card3/hand_cardright_bg.png")
                    card:setFlippedX(true)
                    return card
	             end 
	        else
	            ...
	            local cbColor = Bit:_rshift(Bit:_and(data,0xF0),4)
	            if cardIndex == 0 then
	                return ccui.ImageView:create(string.format("majiang/card/card0/desktop_card_left%d%d.png",cbColor,cbValue))
	            elseif cardIndex == 1 then
	                return ccui.ImageView:create(string.format("majiang/card/card1/desktop_card_left%d%d.png",cbColor,cbValue))
	            elseif cardIndex == 2 then
	                return ccui.ImageView:create(string.format("majiang/card/card2/desktop_card_left%d%d.png",cbColor,cbValue))
                else
                    return ccui.ImageView:create(string.format("majiang/card/card%d/desktop_card_left%d%d.png",cardIndex,cbColor,cbValue))
	            end
	        end
	    elseif viewID == 3 then
	        if data == 0 then
	            if cardIndex == 0 then
	                return ccui.ImageView:create("majiang/card/card0/hand_card_bg.png")
	            elseif cardIndex == 1 then
	                return ccui.ImageView:create("majiang/card/card1/hand_card_bg.png")
	            elseif cardIndex == 2 then
	                return ccui.ImageView:create("majiang/card/card2/hand_card_bg.png")
                elseif cardIndex == 3 then
                    return ccui.ImageView:create("majiang/card/card3/hand_card_bg.png")
	            end 
	        else
	            local cbValue = Bit:_and(data,0x0F)
	            local cbColor = Bit:_rshift(Bit:_and(data,0xF0),4)
	            if cardIndex == 0 then
	                return ccui.ImageView:create(string.format("majiang/card/card0/desktop_card%d%d.png",cbColor,cbValue))
	            elseif cardIndex == 1 then
	                return ccui.ImageView:create(string.format("majiang/card/card1/desktop_card%d%d.png",cbColor,cbValue))
	            elseif cardIndex ==2 then
	                return ccui.ImageView:create(string.format("majiang/card/card2/desktop_card%d%d.png",cbColor,cbValue))
                else
                    return ccui.ImageView:create(string.format("majiang/card/card%d/desktop_card%d%d.png",cardIndex,cbColor,cbValue))
	            end
	        end
	    elseif viewID == 4 then
	        if data == 0 then
	            if cardIndex == 0 then
	                return ccui.ImageView:create("majiang/card/card0/hand_cardright_bg.png")
	            elseif cardIndex == 1 then
	                return ccui.ImageView:create("majiang/card/card1/hand_cardright_bg.png")
	            elseif cardIndex == 2 then
	                return ccui.ImageView:create("majiang/card/card2/hand_cardright_bg.png")
                elseif cardIndex == 3 then
                    return ccui.ImageView:create("majiang/card/card3/hand_cardright_bg.png")
	            end
	        else
	            local cbValue = Bit:_and(data,0x0F)
	            local cbColor = Bit:_rshift(Bit:_and(data,0xF0),4)
	        ...
	        if data == 0 then
	            ...
	            local cbColor = Bit:_rshift(Bit:_and(data,0xF0),4)
	            if cardIndex == 0 then
	                return ccui.ImageView:create(string.format("majiang/card/card0/hand_card%d%d.png",cbColor,cbValue))
	            elseif cardIndex == 1 then
	                return ccui.ImageView:create(string.format("majiang/card/card1/hand_card%d%d.png",cbColor,cbValue))
	            elseif cardIndex == 2 then
	                return ccui.ImageView:create(string.format("majiang/card/card2/hand_card%d%d.png",cbColor,cbValue))
                else
                    return ccui.ImageView:create(string.format("majiang/card/card%d/hand_card%d%d.png",cardIndex,cbColor,cbValue))
	            end
	        end
	    end
    end    
...
function GameCommon:getDiscardCardAndWeaveItemArray(data,viewID)
    ...
    if (GameCommon.tableConfig.wKindID == 65 or GameCommon.tableConfig.wKindID == 54)and data == 0x31 then 
	    ...
	    if viewID == 2 then
	        if data == 0 then
	            if cardIndex == 0 then
	                local card = ccui.ImageView:create("majiang/card/card0/desktop_card_rightbg.png")
	                return card
	            elseif cardIndex == 1 then
	                local card = ccui.ImageView:create("majiang/card/card1/desktop_card_rightbg.png")
	                return card
	            elseif cardIndex == 2 then
	                local card = ccui.ImageView:create("majiang/card/card2/desktop_card_rightbg.png")
	                return card
                elseif cardIndex == 3 then
                    local card = ccui.ImageView:create("majiang/card/card3/desktop_card_rightbg.png")
                    return card
	            end 
	        else
	            local cbValue = Bit:_and(data,0x0F)
	    ...
	    elseif viewID == 4 then
	        if data == 0 then
	            if cardIndex == 0 then
	                return ccui.ImageView:create("majiang/card/card0/desktop_card_rightbg.png")
	            elseif cardIndex == 1 then
	                return ccui.ImageView:create("majiang/card/card1/desktop_card_rightbg.png")
	            elseif cardIndex == 2 then
	                return ccui.ImageView:create("majiang/card/card2/desktop_card_rightbg.png")
                elseif cardIndex == 3 then
                    return ccui.ImageView:create("majiang/card/card3/desktop_card_rightbg.png")
	            end 
	        else
	            local cbValue = Bit:_and(data,0x0F)
	            local cbColor = Bit:_rshift(Bit:_and(data,0xF0),4)
...
function GameCommon:playAnimation(root,id, wChairID)
    local Animation = require("game.majiang.97.Animation")
    if GameCommon.tableConfig.wKindID == 65 or GameCommon.tableConfig.wKindID == 54 then 
    	  Animation = require("game.majiang.97.Animation1")
    end 
