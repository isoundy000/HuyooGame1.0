...
function GameOpration:showOpration(pBuffer)
    ...
    if Bit:_and(cbOperateCode,GameCommon.WIK_CHI_HU) ~= 0 then
        ...
        if Bit:_and(GameCommon.cbOperateCode,GameCommon.WIK_WD) ~= 0  or mUserWCWDActionEx == 1   then
            if pBuffer.cbActionCard == 49 then
...
function GameOpration:deal65Chi(pBuffer)
    ...
    if(cbCardList[49]~= 0 and cbCardList[50]~= 0 and cbCardList[51]~= 0 )and (cbOperateCard == 49 or cbOperateCard == 50 or cbOperateCard == 51) then 
        local ChiCard = {}
        ChiCard[1] = 49 
        ChiCard[2] = 50 
        ChiCard[3] = 51 
    ...
    if(cbCardList[49]~= 0 and cbCardList[50]~= 0 and cbCardList[52]~= 0 )and (cbOperateCard == 49 or cbOperateCard == 50 or cbOperateCard == 52) then 
        local ChiCard = {}
        ChiCard[1] = 49 
        ChiCard[2] = 50 
        ChiCard[3] = 52 
    ...
    if(cbCardList[50]~= 0 and cbCardList[51]~= 0 and cbCardList[52]~= 0 )and (cbOperateCard == 50 or cbOperateCard == 51 or cbOperateCard == 52) then 
        local ChiCard = {}
        ChiCard[1] = 50 
        ChiCard[2] = 51 
        ChiCard[3] = 52 
