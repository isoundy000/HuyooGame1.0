    ...
    if targetType == nil or targetType == GameCommon.CardType_3Add2 then
        ...
        for key, var in pairs(tableSortCardTemp[3]) do
            ...
            if value > targetValue then
                ...
                if targetCardData == nil or (targetCardData ~= nil and (#tableReturnCard == #targetCardData or (GameCommon.tableConfig.wKindID == 26 and #tableReturnCard == bUserCardCount and bUserCardCount >= 3))) then
                    table.insert(tableCard,#tableCard+1,tableReturnCard)
                end
            end
        end
