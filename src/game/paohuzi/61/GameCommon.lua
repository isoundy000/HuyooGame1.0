...
--    self.meChairID = 0
    ...
    self.Cannotcard = {} --不能出的牌
    self.bAbandonChiCard = {} -- 不能吃的组合
end
...
function GameCommon:getViewIDByChairID(wChairID, isNoSwitch)
    ...
    if not isNoSwitch and wPlayerCount == 2 and viewID == 2 then
        if (CHANNEL_ID ==0 or CHANNEL_ID == 1 or CHANNEL_ID == 20 or CHANNEL_ID == 21) then  --and self.tableConfig.wKindID == 34
            viewID = 2
        else
            viewID = 3
        end
...
function GameCommon:GetCardHand(data)
    ...
    elseif data <= 10 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card0/x%d.png",data))
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card1/x%d.png",data))
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card2/x%d.png",data))
        elseif cardIndex == 3 then
            imgCard = ccui.ImageView:create(string.format("zipai/card/card3/x%d.png",data))
        end
    elseif data > 10 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card0/d%d.png",data-16))
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card1/d%d.png",data-16))
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card2/d%d.png",data-16))
        elseif cardIndex == 3 then
...
function GameCommon:getSendOrOutCard(data, isSendCard)
    ...
    elseif data <= 10 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card0/dx%d.png",data))
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card1/dx%d.png",data))
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card2/dx%d.png",data))
        elseif cardIndex == 3 then
            imgCard = ccui.ImageView:create(string.format("zipai/card/card3/dx%d.png",data))
        end
    elseif data > 10 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card0/dd%d.png",data-16))
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card1/dd%d.png",data-16))
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card2/dd%d.png",data-16))
        elseif cardIndex == 3 then
...
function GameCommon:getDiscardCardAndWeaveItemArray(data)
    ...
    elseif data <= 10 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card0/ss%d.png",data))
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card1/ss%d.png",data))
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card2/ss%d.png",data))
        elseif cardIndex == 3 then
            imgCard = ccui.ImageView:create(string.format("zipai/card/card3/ss%d.png",data))
        end
    elseif data > 10 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card0/s%d.png",data-16))
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card1/s%d.png",data-16))
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create(string.format("zipai/61card/card2/s%d.png",data-16))
        elseif cardIndex == 3 then
...
function GameCommon:playAnimation(root, id, wChairID)
    ...
    if AnimationData.animFile ~= nil and AnimationData.animFile ~= "" then
    ...
    elseif AnimationData.png ~= nil and AnimationData.png ~= "" then  --animFile
        local visibleSize = cc.Director:getInstance():getVisibleSize()
        local uiPanel_tipsCard = ccui.Helper:seekWidgetByName(root,"Panel_tipsCard")               
