...
function GameLayer:readBuffer(luaFunc, mainCmdID, subCmdID)
    ...
    elseif mainCmdID == NetMsgId.MDM_GF_GAME then
        ...
        elseif subCmdID == NetMsgId.SUB_S_GAME_END then
            ...
            --名堂类型
            _tagMsg.pBuffer.wType = luaFunc:readRecvDWORD()--名堂数据
            ...
            _tagMsg.pBuffer.stuTingLong = {}
            for i=0,3 do
                _tagMsg.pBuffer.stuTingLong[i] = {}
                _tagMsg.pBuffer.stuTingLong[i].cbCountSmall = luaFunc:readRecvByte() --小字提long
                _tagMsg.pBuffer.stuTingLong[i].cbCountBig = luaFunc:readRecvByte() --大字提龙
            end
    ...
    elseif mainCmdID == NetMsgId.MDM_GF_GAME then
        if subCmdID == NetMsgId.SUB_S_GAME_START then
            ...
            for i = 0, 3 do
                ...
                print("游戏玩家：",wChairID,GameCommon.player[i])
            end
            ...
            if pBuffer.wWinUser ~= GameCommon.INVALID_CHAIR then
                uiPanel_end:runAction(cc.Sequence:create(
                    ...
                    if GameCommon.tableConfig.nTableType == TableType_SportsRoom then
                        ...
                        uiPanel_end:addChild(require("game.paohuzi.39.GameEndLayer"):create(pBuffer))
                    end 
                    end),
