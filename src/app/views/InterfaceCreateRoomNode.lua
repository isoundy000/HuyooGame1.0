...
function InterfaceCreateRoomNode:onCreate(parameter)
    ...
    FatigueLimit = parameter[7]

    -- 创房邀请
    -- self.inviteID = parameter[7] or {}
    -- dump(self.inviteID, '创房邀请:')
    -- for i=1,7 do
    --     if not self.inviteID[i] then
    --         self.inviteID[i] = 0
    --     end
    -- end
...
function InterfaceCreateRoomNode:SUB_GR_LOGON_SUCCESS(event)
    ...
    elseif self.wKindID == 24 then
        NetMgr:getGameInstance():sendMsgToSvr(NetMsgId.MDM_GR_USER,NetMsgId.REQ_GR_CREATE_TABLE,"diwwwwdbbbbbbwbbbbbbbbdbbbbbbbb",
            ...
            ,self.tableParameter.bStartBanker,self.tableParameter.bStopCardGo,self.tableParameter.bHostedTime,self.tableParameter.bHostedSession) 
    ...
    elseif self.wKindID == 25 or self.wKindID == 26  then
        NetMgr:getGameInstance():sendMsgToSvr(NetMsgId.MDM_GR_USER,NetMsgId.REQ_GR_CREATE_TABLE,"diwwwwdbbbbbbbbbbbbbb",
            CHANNEL_ID,self.nTableType,self.wTableSubType,self.wKindID,self.wGameCount,1,self.dwTargetID,
            ...
            self.tableParameter.bHostedTime,self.tableParameter.bHostedSession,self.tableParameter.b4Add2,self.tableParameter.bDel345)
    ...
    elseif self.wKindID == 45 then
        NetMgr:getGameInstance():sendMsgToSvr(NetMsgId.MDM_GR_USER,NetMsgId.REQ_GR_CREATE_TABLE,"diwwwwdbbbbbbbbbb",--b
            CHANNEL_ID,self.nTableType,self.wTableSubType,self.wKindID,self.wGameCount,1,self.dwTargetID,
            self.tableParameter.bPlayerCount,self.tableParameter.bMaType,self.tableParameter.bMaCount,self.tableParameter.bQGHu,
            self.tableParameter.bQGHuJM,self.tableParameter.bHuangZhuangHG,self.tableParameter.bQingSH,self.tableParameter.bJiePao,self.tableParameter.bNiaoType,self.tableParameter.bWuTong)--,self.tableParameter.bQiDui
    elseif self.wKindID == 46 then
        NetMgr:getGameInstance():sendMsgToSvr(NetMsgId.MDM_GR_USER,NetMsgId.REQ_GR_CREATE_TABLE,"diwwwwdbbbbbbbbbb",
            ...
            self.tableParameter.bHuangZhuangHG,self.tableParameter.bJiePao,self.tableParameter.mNiaoType,self.tableParameter.bQiDui,self.tableParameter.bWuTong)   
    elseif self.wKindID == 61 then
        NetMgr:getGameInstance():sendMsgToSvr(NetMsgId.MDM_GR_USER,NetMsgId.REQ_GR_CREATE_TABLE,"diwwwwdbwbbbbbbbbbbbb",
        CHANNEL_ID,self.nTableType,self.wTableSubType,self.wKindID,self.wGameCount,1,self.dwTargetID,        
        self.tableParameter.bPlayerCount,self.tableParameter.bMaxLost,
        self.tableParameter.bCanHuXi,self.tableParameter.bStartBanker,self.tableParameter.bDeathCard,
        self.tableParameter.bHostedTime,self.tableParameter.bHostedSession,self.tableParameter.bKaWai,
        self.tableParameter.bXianJiaDiHu,self.tableParameter.bZhuangJiaDiHu,self.tableParameter.bHuDaYuWai,
        self.tableParameter.bHaoFen,self.tableParameter.bMingTang,self.tableParameter.bPiaoFen)        
    ...
    elseif self.wKindID == 53 then
        NetMgr:getGameInstance():sendMsgToSvr(NetMsgId.MDM_GR_USER,NetMsgId.REQ_GR_CREATE_TABLE,"diwwwwdbbbbbbbb",
            CHANNEL_ID,self.nTableType,self.wTableSubType,self.wKindID,self.wGameCount,1,self.dwTargetID,
            self.tableParameter.bPlayerCount,self.tableParameter.bBankerType,self.tableParameter.bMultiple,self.tableParameter.bBettingType,
            self.tableParameter.bPush,self.tableParameter.bCanPlayingJoin,self.tableParameter.bExtreme,self.tableParameter.bCuopai)     
    ...
    elseif self.wKindID == 60 then
        NetMgr:getGameInstance():sendMsgToSvr(NetMsgId.MDM_GR_USER,NetMsgId.REQ_GR_CREATE_TABLE,"diwwwwdbbbbbbwbbbbbbbbdbb",
            ...
            self.tableParameter.bYiWuShi,self.tableParameter.bLiangPai,self.tableParameter.bCanHuXi,self.tableParameter.bHuType,
            self.tableParameter.bFangPao,self.tableParameter.bSettlement,self.tableParameter.bStartTun,self.tableParameter.bSocreType,
            self.tableParameter.dwMingTang,self.tableParameter.bTurn,self.tableParameter.bStartBanker)  
    ...
    elseif self.wKindID == 67 then
        NetMgr:getGameInstance():sendMsgToSvr(NetMsgId.MDM_GR_USER,NetMsgId.REQ_GR_CREATE_TABLE,"diwwwwdbbbbbbbbbbbbbbblbbb",--l
            CHANNEL_ID,self.nTableType,self.wTableSubType,self.wKindID,self.wGameCount,1,self.dwTargetID,
            self.tableParameter.bPlayerCount,self.tableParameter.bMaType,self.tableParameter.bMaCount,self.tableParameter.bQGHu,
            self.tableParameter.bQGHuJM,self.tableParameter.bHuangZhuangHG,self.tableParameter.bQingSH,self.tableParameter.bJiePao,self.tableParameter.bNiaoType,
            ...
            self.tableParameter.mJFCount,self.tableParameter.bLongQD,self.tableParameter.bHostedTime,self.tableParameter.bHostedSession) 
    ...
    elseif self.wKindID == 68 then
        NetMgr:getGameInstance():sendMsgToSvr(NetMsgId.MDM_GR_USER,NetMsgId.REQ_GR_CREATE_TABLE,"diwwwwdbbbbbbbbbbbbb",
            ...
            self.tableParameter.bWuTong,self.tableParameter.bHostedTime,self.tableParameter.bHostedSession)

    elseif self.wKindID == 97 then  
        NetMgr:getGameInstance():sendMsgToSvr(NetMsgId.MDM_GR_USER,NetMsgId.REQ_GR_CREATE_TABLE,"diwwwwdbbbbbbbbbbbb",
            CHANNEL_ID,self.nTableType,self.wTableSubType,self.wKindID,self.wGameCount,1,self.dwTargetID,
            self.tableParameter.bPlayerCount,self.tableParameter.bYJLY,self.tableParameter.bDiFen,self.tableParameter.bQGHu,self.tableParameter.bQGHuBaoPei,self.tableParameter.bLiangMenPai,
            self.tableParameter.bDiaoYu,self.tableParameter.bLGDP,self.tableParameter.bSLYX,self.tableParameter.bSLYXNum,
            self.tableParameter.bHostedTime,self.tableParameter.bHostedSession)
    else
    end
end
