...
function SportsCreateLayer:createSports()
    ...
    elseif self.settingsData.wKindID == 24 then
        NetMgr:getLogicInstance():sendMsgToSvr(NetMsgId.MDM_CL_SPORTS,NetMsgId.REQ_SPORTS_CREATE,"ddbdwbbbbbbbwbbbbbbbbdbbbbbbbb",
            CHANNEL_ID,self.sportsData.dwKey,1,dwCost,self.settingsData.wKindID,self.settingsData.tableParameter.bPlayerCount,
            self.settingsData.tableParameter.FanXing.bType,self.settingsData.tableParameter.FanXing.bCount,self.settingsData.tableParameter.FanXing.bAddTun,
            self.settingsData.tableParameter.bPlayerCountType,self.settingsData.tableParameter.bPlayerCount,self.settingsData.tableParameter.bLaiZiCount,
            self.settingsData.tableParameter.bMaxLost,self.settingsData.tableParameter.bYiWuShi,self.settingsData.tableParameter.bLiangPai,self.settingsData.tableParameter.bCanHuXi,self.settingsData.tableParameter.bHuType,
            ...
            self.settingsData.tableParameter.bPiaoHu,self.settingsData.tableParameter.bHongHu,self.settingsData.tableParameter.bDelShowCardHu,self.settingsData.tableParameter.bDeathCard,self.settingsData.tableParameter.bStartBanker,
            self.settingsData.tableParameter.bStopCardGo,self.settingsData.tableParameter.bHostedTime,self.settingsData.tableParameter.bHostedSession) 
    ...
    elseif self.settingsData.wKindID == 25 or self.settingsData.wKindID == 26  then
        NetMgr:getLogicInstance():sendMsgToSvr(NetMsgId.MDM_CL_SPORTS,NetMsgId.REQ_SPORTS_CREATE,"ddbdwbbbbbbbbbbbbbbb",
            CHANNEL_ID,self.sportsData.dwKey,1,dwCost,self.settingsData.wKindID,self.settingsData.tableParameter.bPlayerCount,
            ...
            self.settingsData.tableParameter.bHostedTime,self.settingsData.tableParameter.bHostedSession,self.settingsData.tableParameter.b4Add2,self.settingsData.tableParameter.bDel345)
    ...
    elseif self.settingsData.wKindID == 34 then
        -- if CHANNEL_ID == 10 or CHANNEL_ID == 11 then 
            NetMgr:getLogicInstance():sendMsgToSvr(NetMsgId.MDM_CL_SPORTS,NetMsgId.REQ_SPORTS_CREATE,"ddbdwbbbbbbbwbbbbbbbbdbbbb",
                CHANNEL_ID,self.sportsData.dwKey,1,dwCost,self.settingsData.wKindID,self.settingsData.tableParameter.bPlayerCount,
                self.settingsData.tableParameter.FanXing.bType,self.settingsData.tableParameter.FanXing.bCount,self.settingsData.tableParameter.FanXing.bAddTun,
                self.settingsData.tableParameter.bPlayerCountType,self.settingsData.tableParameter.bPlayerCount,self.settingsData.tableParameter.bLaiZiCount,self.settingsData.tableParameter.bMaxLost,self.settingsData.tableParameter.bYiWuShi,self.settingsData.tableParameter.bLiangPai,self.settingsData.tableParameter.bCanHuXi,self.settingsData.tableParameter.bHuType,
                ...
                self.settingsData.tableParameter.bHostedSession)
        -- else     
        --     NetMgr:getLogicInstance():sendMsgToSvr(NetMsgId.MDM_CL_SPORTS,NetMsgId.REQ_SPORTS_CREATE,"ddbdwbbbbbbbwbbbbbbbbdb",
        --         CHANNEL_ID,self.sportsData.dwKey,1,dwCost,self.settingsData.wKindID,self.settingsData.tableParameter.bPlayerCount,
        --         self.settingsData.tableParameter.FanXing.bType,self.settingsData.tableParameter.FanXing.bCount,self.settingsData.tableParameter.FanXing.bAddTun,
    ...
    elseif self.settingsData.wKindID == 37 then
        NetMgr:getLogicInstance():sendMsgToSvr(NetMsgId.MDM_CL_SPORTS,NetMsgId.REQ_SPORTS_CREATE,"ddbdwbbbbbbbwbbbbbbbbdbbb",
            ...
            self.settingsData.tableParameter.bPlayerCount,self.settingsData.tableParameter.bLaiZiCount,self.settingsData.tableParameter.bMaxLost,self.settingsData.tableParameter.bYiWuShi,self.settingsData.tableParameter.bLiangPai,
            self.settingsData.tableParameter.bCanHuXi,self.settingsData.tableParameter.bHuType,self.settingsData.tableParameter.bFangPao,self.settingsData.tableParameter.bSettlement,self.settingsData.tableParameter.bStartTun,
            self.settingsData.tableParameter.bSocreType,self.settingsData.tableParameter.dwMingTang,self.settingsData.tableParameter.bLimit,self.settingsData.tableParameter.bHostedTime,self.settingsData.tableParameter.bHostedSession)
    ...
    elseif self.settingsData.wKindID == 40 then
        NetMgr:getLogicInstance():sendMsgToSvr(NetMsgId.MDM_CL_SPORTS,NetMsgId.REQ_SPORTS_CREATE,"ddbdwbbbbbbbwbbbbbbbbdbbbbbbbbbb",
            CHANNEL_ID,self.sportsData.dwKey,1,dwCost,self.settingsData.wKindID,self.settingsData.tableParameter.bPlayerCount,
            self.settingsData.tableParameter.FanXing.bType,self.settingsData.tableParameter.FanXing.bCount,self.settingsData.tableParameter.FanXing.bAddTun,
            ...
            self.settingsData.tableParameter.bCardCount21,self.settingsData.tableParameter.bMinLostCell,self.settingsData.tableParameter.bMinLost,self.settingsData.tableParameter.bDeathCard
            ,self.settingsData.tableParameter.bStartBanker,self.settingsData.tableParameter.bDelShowCardHu,self.settingsData.tableParameter.bPiaoHu,self.settingsData.tableParameter.bStopCardGo
            ,self.settingsData.tableParameter.bHostedTime,self.settingsData.tableParameter.bHostedSession)
    ...
    elseif self.settingsData.wKindID == 61 then
        NetMgr:getLogicInstance():sendMsgToSvr(NetMsgId.MDM_CL_SPORTS,NetMsgId.REQ_SPORTS_CREATE,"ddbdwbbbbbbbbbbbbbbb",
            CHANNEL_ID,self.sportsData.dwKey,1,dwCost,self.settingsData.wKindID,self.settingsData.tableParameter.bPlayerCount,
            self.settingsData.tableParameter.bPlayerCount,self.settingsData.tableParameter.bMaxLost,
            self.settingsData.tableParameter.bCanHuXi,self.settingsData.tableParameter.bStartBanker,self.settingsData.tableParameter.bDeathCard,
            self.settingsData.tableParameter.bHostedTime,self.settingsData.tableParameter.bHostedSession,self.settingsData.tableParameter.bKaWai,
            self.settingsData.tableParameter.bXianJiaDiHu,self.settingsData.tableParameter.bZhuangJiaDiHu,self.settingsData.tableParameter.bHuDaYuWai,
            self.settingsData.tableParameter.bHaoFen,self.settingsData.tableParameter.bMingTang,self.settingsData.tableParameter.bPiaoFen)         
    ...
    elseif self.settingsData.wKindID == 48 then
        NetMgr:getLogicInstance():sendMsgToSvr(NetMsgId.MDM_CL_SPORTS,NetMsgId.REQ_SPORTS_CREATE,"ddbdwbbbbbbbwbbbbbbbbdbbbbbbbbbb",
            ...
            self.settingsData.tableParameter.bFangPao,self.settingsData.tableParameter.bSettlement,self.settingsData.tableParameter.bStartTun,self.settingsData.tableParameter.bSocreType,
            self.settingsData.tableParameter.dwMingTang,self.settingsData.tableParameter.bTurn,self.settingsData.tableParameter.bPaoTips,self.settingsData.tableParameter.bStartBanker,
            self.settingsData.tableParameter.bSiQiHong,self.settingsData.tableParameter.bDelShuaHou,self.settingsData.tableParameter.bHuangFanAddUp,self.settingsData.tableParameter.bTingHuAll,
            self.settingsData.tableParameter.bDeathCard,self.settingsData.tableParameter.bHostedTime,self.settingsData.tableParameter.bHostedSession)  

    elseif self.settingsData.wKindID == 49 then
        NetMgr:getLogicInstance():sendMsgToSvr(NetMsgId.MDM_CL_SPORTS,NetMsgId.REQ_SPORTS_CREATE,"ddbdwbbbbbbbwbbbbbbbbdbbbbbbb",
            CHANNEL_ID,self.sportsData.dwKey,1,dwCost,self.settingsData.wKindID,self.settingsData.tableParameter.bPlayerCount,
            self.settingsData.tableParameter.FanXing.bType,self.settingsData.tableParameter.FanXing.bCount,self.settingsData.tableParameter.FanXing.bAddTun,
            self.settingsData.tableParameter.bPlayerCountType,self.settingsData.tableParameter.bPlayerCount,self.settingsData.tableParameter.bLaiZiCount,self.settingsData.tableParameter.bMaxLost,
            self.settingsData.tableParameter.bYiWuShi,self.settingsData.tableParameter.bLiangPai,self.settingsData.tableParameter.bCanHuXi,self.settingsData.tableParameter.bHuType,
            self.settingsData.tableParameter.bFangPao,self.settingsData.tableParameter.bSettlement,self.settingsData.tableParameter.bStartTun,self.settingsData.tableParameter.bSocreType,
            self.settingsData.tableParameter.dwMingTang,self.settingsData.tableParameter.bTurn,self.settingsData.tableParameter.bDeathCard,self.settingsData.tableParameter.bStartBanker,
            self.settingsData.tableParameter.bHuangFanAddUp,self.settingsData.tableParameter.STWK,self.settingsData.tableParameter.bHostedTime,self.settingsData.tableParameter.bHostedSession) 
    ...
    elseif self.settingsData.wKindID == 70 then
        NetMgr:getLogicInstance():sendMsgToSvr(NetMsgId.MDM_CL_SPORTS,NetMsgId.REQ_SPORTS_CREATE,"ddbdwbbbbbbbbbbbbbbbbbbbbbb",
            ...
            self.settingsData.tableParameter.bYZHFlag,self.settingsData.tableParameter.bMQFlag,self.settingsData.tableParameter.mZXFlag,self.settingsData.tableParameter.mPFFlag,
            self.settingsData.tableParameter.mZTSXlag,self.settingsData.tableParameter.bJJHFlag,self.settingsData.tableParameter.bWuTong,self.settingsData.tableParameter.mMaOne,
            self.settingsData.tableParameter.mZTLLSFlag,self.settingsData.tableParameter.mKGNPFlag,self.settingsData.tableParameter.bHostedTime,self.settingsData.tableParameter.bHostedSession)   
    ...
    elseif self.settingsData.wKindID == 67 then
        NetMgr:getLogicInstance():sendMsgToSvr(NetMsgId.MDM_CL_SPORTS,NetMsgId.REQ_SPORTS_CREATE,"ddbdwbbbbbbbbbbbbbbbblbbb",
            CHANNEL_ID,self.sportsData.dwKey,1,dwCost,self.settingsData.wKindID,self.settingsData.tableParameter.bPlayerCount,
            self.settingsData.tableParameter.bPlayerCount,self.settingsData.tableParameter.bMaType,self.settingsData.tableParameter.bMaCount,self.settingsData.tableParameter.bQGHu,
            self.settingsData.tableParameter.bQGHuJM,self.settingsData.tableParameter.bHuangZhuangHG,self.settingsData.tableParameter.bQingSH,self.settingsData.tableParameter.bJiePao,self.settingsData.tableParameter.bNiaoType,            
            ...
            self.settingsData.tableParameter.mJFCount,self.settingsData.tableParameter.bLongQD,self.settingsData.tableParameter.bHostedTime,self.settingsData.tableParameter.bHostedSession)   

    elseif self.settingsData.wKindID == 97 then
        NetMgr:getLogicInstance():sendMsgToSvr(NetMsgId.MDM_CL_SPORTS,NetMsgId.REQ_SPORTS_CREATE,"ddbdwbbbbbbbbbbbbb",
            CHANNEL_ID,self.sportsData.dwKey,1,dwCost,self.settingsData.wKindID,self.settingsData.tableParameter.bPlayerCount,
            self.settingsData.tableParameter.bPlayerCount,self.settingsData.tableParameter.bYJLY,self.settingsData.tableParameter.bDiFen,self.settingsData.tableParameter.bQGHu,self.settingsData.tableParameter.bQGHuBaoPei,
            self.settingsData.tableParameter.bLiangMenPai,self.settingsData.tableParameter.bDiaoYu,self.settingsData.tableParameter.bLGDP,self.settingsData.tableParameter.bSLYX,           
            self.settingsData.tableParameter.bSLYXNum
            self.settingsData.tableParameter.bHostedTime,self.settingsData.tableParameter.bHostedSession)                              
    else
    end
end
