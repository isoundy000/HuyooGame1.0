...
--    local mousic = string.format("achannel/%d/music.mp3",CHANNEL_ID)
--    cc.SimpleAudioEngine:getInstance():playMusic(mousic,true)
    self.uiLoadingBar_pro = ccui.Helper:seekWidgetByName(self.root,"LoadingBar_pro")
    self.uiAtlasLabel_proValue = ccui.Helper:seekWidgetByName(self.root,"AtlasLabel_proValue")
    self.uiAtlasLabel_proValue:setString(string.format("%0.2f/",0))
...
function LoadingLayer:update(dt)
    ...
    self.uiAtlasLabel_proValue:setString(string.format("%0.2f/",pro))
