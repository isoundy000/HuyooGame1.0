...
mkdir 正式包\res\achannel\2
xcopy res\achannel\2 正式包\res\achannel\2 /e
...
mkdir 渠道2
xcopy 正式包 渠道2 /e
mkdir 正式包\src\version\2
mkdir 渠道2\src\version\2
copy ".\src\version\2\*" ".\渠道2\src\version\2\"
:这里删除不需要的文件夹，例如：rd /s/q 文件名
start /wait VerstionBuild.exe 渠道2\ 渠道2\src\version\2\version.manifest 渠道2\src\version\2\project.manifest
copy ".\渠道2\src\version\2\*" ".\正式包\src\version\2\"
