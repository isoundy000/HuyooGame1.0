...
mkdir 正式包\res\achannel\20
xcopy res\achannel\20 正式包\res\achannel\20 /e
...
mkdir 渠道20
xcopy 正式包 渠道20 /e
mkdir 正式包\src\version\20
mkdir 渠道20\src\version\20
copy ".\src\version\20\*" ".\渠道20\src\version\20\"
:这里删除不需要的文件夹，例如：rd /s/q 文件名
start /wait VerstionBuild.exe 渠道20\ 渠道20\src\version\20\version.manifest 渠道20\src\version\20\project.manifest
copy ".\渠道20\src\version\20\*" ".\正式包\src\version\20\"
