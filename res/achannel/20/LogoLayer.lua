...
function LogoLayer:onCreate()     
    self:runAction(cc.Sequence:create(cc.FadeIn:create(0),cc.DelayTime:create(0),cc.CallFunc:create(function(sender,event) 
...
--        local logo = ccui.ImageView:create(string.format("achannel/%d/logo.png",CHANNEL_ID))
--        self:addChild(logo)
