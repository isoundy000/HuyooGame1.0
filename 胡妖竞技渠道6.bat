...
mkdir 正式包\res\achannel\6
xcopy res\achannel\6 正式包\res\achannel\6 /e
...
mkdir 渠道6
xcopy 正式包 渠道6 /e
mkdir 正式包\src\version\6
mkdir 渠道6\src\version\6
copy ".\src\version\6\*" ".\渠道6\src\version\6\"
:这里删除不需要的文件夹，例如：rd /s/q 文件名
start /wait VerstionBuild.exe 渠道6\ 渠道6\src\version\6\version.manifest 渠道6\src\version\6\project.manifest
copy ".\渠道6\src\version\6\*" ".\正式包\src\version\6\"
