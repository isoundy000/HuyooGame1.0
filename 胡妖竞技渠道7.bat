...
mkdir 正式包\res\achannel\7
xcopy res\achannel\7 正式包\res\achannel\7 /e
...
mkdir 渠道7
xcopy 正式包 渠道7 /e
mkdir 正式包\src\version\7
mkdir 渠道7\src\version\7
copy ".\src\version\7\*" ".\渠道7\src\version\7\"
:这里删除不需要的文件夹，例如：rd /s/q 文件名
start /wait VerstionBuild.exe 渠道7\ 渠道7\src\version\7\version.manifest 渠道7\src\version\7\project.manifest
copy ".\渠道7\src\version\7\*" ".\正式包\src\version\7\"
