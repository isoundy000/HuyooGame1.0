...
mkdir 正式包\res\achannel\1
xcopy res\achannel\1 正式包\res\achannel\1 /e
...
mkdir 渠道1
xcopy 正式包 渠道1 /e
mkdir 正式包\src\version\1
mkdir 渠道1\src\version\1
copy ".\src\version\1\*" ".\渠道1\src\version\1\"
:这里删除不需要的文件夹，例如：rd /s/q 文件名
start /wait VerstionBuild.exe 渠道1\ 渠道1\src\version\1\version.manifest 渠道1\src\version\1\project.manifest
copy ".\渠道1\src\version\1\*" ".\正式包\src\version\1\"
