...
mkdir 正式包\res\achannel\8
xcopy res\achannel\8 正式包\res\achannel\8 /e
...
mkdir 渠道8
xcopy 正式包 渠道8 /e
mkdir 正式包\src\version\8
mkdir 渠道8\src\version\8
copy ".\src\version\8\*" ".\渠道8\src\version\8\"
:这里删除不需要的文件夹，例如：rd /s/q 文件名
start /wait VerstionBuild.exe 渠道8\ 渠道8\src\version\8\version.manifest 渠道8\src\version\8\project.manifest
copy ".\渠道8\src\version\8\*" ".\正式包\src\version\8\"
